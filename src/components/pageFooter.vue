<template>
<div class="w-full bg-slate-900  lg:px-5 ">
    <div class="md:flex md:justify-between my-4 p-4 items-center md:text-lg lg:text-xl ">
        <div>
            <img src="" alt="Logo">
        </div>
        <div class="md:flex gap-4 text-gray-200  items-center md:text-lg lg:text-xl">
            <h1 class=" my-3 md:my-0 text-base text-gray-300 md:text-lg lg:text-xl  primary_heading_sub">Ready to get started?</h1>
            <button class="btn animated_btn btn_effect btn_effect_bg bg-transparent w-36 p-2
