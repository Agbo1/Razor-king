...
<div class="w-full py-7 2xl:w-full  lg:justify-between md:w-full lg:w-full lg:flex justify-between px-10 2xl:gap-x-96 2xl:p-56 ">
    <div class="lg:w-96  md:w-full 2xl:w-full md:p-4">
        ...
        <div class=" hidden md:flex md:justify-between lg:text-base md:text-base pt-8 md:w-full 2xl:text-5xl md:gap-8">
            <div class="flex gap-6">
                <div class="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 2xl:h-14 2xl:w-14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
        ...
        <!-- <div class=" hidden md:flex md:justify-between md:text-base lg:w-full ">
    ...
    <div class="lg:w-80 md:my-10 lg:my-0 2xl:my-0 md:w-96 xl:mr-3 2xl:w-full">
        ...
        <div class="group inline-block w-full md:pl-3 flex items-center ">
            <span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-8 md:w-8 2xl:h-16 2xl:w-16 mr-1 2xl:mt-6 2xl:mr-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg></span>
            <button class="outline-none focus:outline-none py-1 bg-white rounded-sm flex items-center min-w-full">
                <span class="pr-1 font-semibold text-sm md:text-sm font-sans flex-1 lg:text-base xl:text-sm 2xl:text-5xl 2xl:mt-8 w-full text-left "> Open now 10:00am - 8:00pm</span>
                <span class="ml-5 2xl:pr-96">
                    <svg class="fill-current h-4 w-4 2xl:h-10 2xl:w-10 2xl:mr-96  transform group-hover:-rotate-180
        transition duration-150 ease-in-out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />
                    </svg>
                </span>
            </button>
            <ul class="bg-white transform scale-0 group-hover:scale-100 absolute 
  transition duration-150 ease-in-out origin-top min-w-32 2xl:text-5xl ">
